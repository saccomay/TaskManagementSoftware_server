...
@RestController
@RequestMapping("/api/task-management-software-server-kafka")
public class TaskManagementSoftwareServerKafkaResource {

    private final Logger log = LoggerFactory.getLogger(TaskManagementSoftwareServerKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public TaskManagementSoftwareServerKafkaResource(KafkaProperties kafkaProperties) {
